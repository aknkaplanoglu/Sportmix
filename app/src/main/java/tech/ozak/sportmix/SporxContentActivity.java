...
/**
 * Created by ako on 18-Feb-16.
 */
public class SporxContentActivity extends AppCompatActivity {
    ...
    private class ProgressTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Elements newsDiv = doc.getElementsByClass("no-select");
                if (newsDiv!=null && newsDiv.size()>0){
                    newsDiv.select("a").remove();
                    newPage = newsDiv.html();
                }
                else{
                    Element habericBody = doc.getElementById("habericBody");
                    habericBody.select("iframe").remove();
                    newPage= habericBody.html();
                }

...
/**
 * Created by ako on 13-Feb-16.
 */
public class CanliSkorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       /* Intent i = getIntent();
        ...
        fikstur_url = getResources().getString(R.string.canli_skor_url);
        Log.d("canli_skor url: ", fikstur_url);
